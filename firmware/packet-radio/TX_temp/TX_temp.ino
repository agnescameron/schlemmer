 ...
 char radiopacket[20] = "Hello World #";
  ...
  if (rf69.waitAvailableTimeout(500))  { 
    ...
    if (rf69.recv(buf, &len)) {
      ...
      readTemp(LED, 50, 3); //blink LED 3 times, 50ms between blinks
    } else {
...
void readTemp(byte PIN, byte DELAY_MS, byte loops) {
  float tempFloat = tempsensor.readTempC();
  temp = round(tempFloat*100.00);
  Serial.print("temp:  "); Serial.print(tempFloat); 
